...
function Chat({ userId }) {
    ...
    const { selectedChat, setSelectedChat, getUserChat } = useChatStore();
    ...
    return (
        <div className={`px-4 py-3 hover:bg-slate-800 ${(userId === selectedChat) && 'bg-slate-800'}`} onClick={() => chatOnClick(userId)}>
            {(user) && 
